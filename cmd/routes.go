...
func (app *application) routes() http.Handler {
	...
	mux.Post("/docs/:filename", authMiddleware.ThenFunc(app.userHandler.ServeProofDocument))
	mux.Get("/user/:id/upgrade", authMiddleware.ThenFunc(app.userHandler.UpdateToWorker))
