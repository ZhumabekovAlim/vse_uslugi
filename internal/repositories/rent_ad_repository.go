...
`
	...
	err := r.DB.QueryRowContext(ctx, query, userID, id).Scan(
		...
		&imagesJSON, &videosJSON, &s.CategoryID, &s.CategoryName, &subcategoryID, &subcategoryName, &s.Description, &s.AvgRating, &s.Top, &s.Liked, &respondedStr, &status, &s.RentType, &s.Deposit, &lat, &lon, &s.CreatedAt,
