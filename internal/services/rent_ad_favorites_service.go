...
func (s *RentAdFavoriteService) GetRentAdFavoritesByUser(ctx context.Context, userID, cityID int) ([]models.RentAdFavorite, error) {
	return s.RentAdFavoriteRepo.GetRentAdFavoritesByUser(ctx, userID, cityID)
}
