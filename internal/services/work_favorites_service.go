...
func (s *WorkFavoriteService) GetWorkFavoritesByUser(ctx context.Context, userID int) ([]models.WorkFavorite, error) {
	return s.WorkFavoriteRepo.GetWorkFavoritesByUser(ctx, userID)
}
