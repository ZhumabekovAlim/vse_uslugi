...
func (h *RentResponseHandler) CancelRentResponse(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Service.CancelRentResponse(r.Context(), responseID, userID); err != nil {
		switch {
