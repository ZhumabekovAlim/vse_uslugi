...
type WorkSubcategoryHandler struct {
	Service *services.WorkSubcategoryService
}

func (h *WorkSubcategoryHandler) CreateSubcategory(w http.ResponseWriter, r *http.Request) {
...
func (h *WorkSubcategoryHandler) GetAllSubcategories(w http.ResponseWriter, r *http.Request) {
...
func (h *WorkSubcategoryHandler) GetByCategory(w http.ResponseWriter, r *http.Request) {
...
func (h *WorkSubcategoryHandler) GetSubcategoryByID(w http.ResponseWriter, r *http.Request) {
...
func (h *WorkSubcategoryHandler) UpdateSubcategoryByID(w http.ResponseWriter, r *http.Request) {
	idStr := r.URL.Query().Get(":id")
	if idStr == "" {
		http.Error(w, "Missing subcategory ID", http.StatusBadRequest)
		return
...
func (h *WorkSubcategoryHandler) DeleteSubcategoryByID(w http.ResponseWriter, r *http.Request) {
	idStr := r.URL.Query().Get(":id")
	if idStr == "" {
		http.Error(w, "Missing subcategory ID", http.StatusBadRequest)
		return
