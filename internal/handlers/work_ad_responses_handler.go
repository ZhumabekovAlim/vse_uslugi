...
func (h *WorkAdResponseHandler) CancelWorkAdResponse(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Service.CancelWorkAdResponse(r.Context(), responseID, userID); err != nil {
		switch {
