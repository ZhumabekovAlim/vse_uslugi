...
func New(orders OrdersRepository, dispatch DispatchRepository, offers OffersRepository, locator *geo.DriverLocator, driverWS DriverNotifier, passengerWS PassengerNotifier, logger Logger, cfg Config) *Dispatcher {
...
func (d *Dispatcher) tick(ctx context.Context) {
    records, err := d.dispatch.ListDue(ctx, time.Now())
    if err != nil {
...
func (d *Dispatcher) processRecord(ctx context.Context, rec repo.DispatchRecord) error {
